    ...
    <Box>
        ...
        <Container id="products" >
            <div className='pcard'>
                ...
                <Typography variant='h4' element="h3" sx={{ marginTop: '10px' }}>غسالات سامسونج</Typography>
            ...
            <div className='pcard'>
                <img src="/مواصفات-ثلاجات-سامسونج-مع-فريزر-علوي.jpg" alt="غسالات كريازي" />
                <Typography variant='h4' element="h3" sx={{ marginTop: '10px' }}>ديب فريزر سامسونج</Typography>
                <div className='mm'>ليه تسيب ثلاجتك عطلانة , مع سامسونج للصيانة ايا يكن عطل الثلاجة هتتصلح بالمنزل بنفس اليوم
            ...
            <div className='pcard'>
                <img src="/مركز-صيانة-تكييف-سامسونج.jpg.webp" alt="غسالات كريازي"/>
                <Typography variant='h4' element="h3" sx={{ marginTop: '10px' }}>تكييفات سامسونج</Typography>
